...
class EnderecoServiceTest {
    ...
    @DisplayName("Deve lançar exceção se os dados do DTO forem inválidos")
    @Test
    void deveLancarExcecaoSeEnderecoDTOInvalido() {
        // Arrange
        EnderecoCreateDTO enderecoCreateDTOInvalido = new EnderecoCreateDTO("", "", "", "", "", "");

        // Act & Assert
        assertThrows(IllegalArgumentException.class, () -> service.save(enderecoCreateDTOInvalido));
    }
}
